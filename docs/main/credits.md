...
- **StrawChannel95** for creating the `nuclearsunset.json` file, consulting on technical aspects of Wabbajack, heavily editing these instructions, and prototyping the [Resources](https://nuclearsunset.net/docs/resources/overview) section.
